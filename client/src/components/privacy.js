...
export default () => (
  <div>
    ...
    Isophex is located at:
    <br />
    <address>
      2048 N. Cleveland Ave Unit 312, Chicago <br />
      60614 - IL , United States
      <br />
    </address>
    <p>
      It is Isophex's policy to respect your privacy regarding any information
      we may collect while operating our website. This Privacy Policy applies to{" "}
      <a href="https://www.isophex.com">https://www.icbm.todo.com</a>{" "}
      (hereinafter, "us", "we", or "https://www.isophex.com"). We respect your
    ...
    <p>
      Like most website operators, Isophex collects non-personally-identifying
      ...
      and the date and time of each visitor request. Isophex's purpose in
      collecting non-personally identifying information is to better understand
      how Isophex's visitors use its website. From time to time, Isophex may
      release non-personally-identifying information in the aggregate, e.g., by
      publishing a report on trends in the usage of its website.
    </p>
    <p>
      Isophex also collects potentially personally-identifying information like
      Internet Protocol (IP) addresses for logged in users and for users leaving
      comments on https://www.isophex.com blog posts. Isophex only discloses
    ...
    <p>
      Certain visitors to Isophex's websites choose to interact with Isophex in
      ways that require Isophex to gather personally-identifying information.
      The amount and type of information that Isophex gathers depends on the
      nature of the interaction. For example, we ask visitors who sign up for a
      blog at https://www.isophex.com to provide a username and email address.
    </p>
    <h2>Security</h2>
    <p>
    ...
    <p>
      Isophex discloses potentially personally-identifying and
      personally-identifying information only to those of its employees,
      contractors and affiliated organizations that (i) need to know that
      information in order to process it on Isophex's behalf or to provide
      services available at Isophex's website, and (ii) that have agreed not to
      ...
      Isophex's website, you consent to the transfer of such information to
      them. Isophex will not rent or sell potentially personally-identifying and
      personally-identifying information to anyone. Other than to its employees,
      contractors and affiliated organizations, as described above, Isophex
      ...
      governmental request, or when Isophex believes in good faith that
      disclosure is reasonably necessary to protect the property or rights of
      Isophex, third parties or the public at large.
    </p>
    <p>
      If you are a registered user of https://www.isophex.com and have supplied
      your email address, Isophex may occasionally send you an email to tell you
      about new features, solicit your feedback, or just keep you up to date
      with what's going on with Isophex and our products. We primarily use our
      ...
      help us support other users. Isophex takes all measures reasonably
    ...
    <h2>Cookies</h2>
    <p>
      To enrich and perfect your online experience, Isophex uses "Cookies",
    ...
    <p>
      ...
      the visitor returns. Isophex uses cookies to help Isophex identify and
      track visitors, their usage of https://www.isophex.com, and their website
      access preferences. Isophex visitors who do not wish to have cookies
      placed on their computers should set their browsers to refuse cookies
      before using Isophex's websites, with the drawback that certain features
      of Isophex's websites may not function properly without the aid of
      cookies.
    </p>
    <p>
      By continuing to navigate our website without changing your cookie
      settings, you hereby acknowledge and agree to Isophex's use of cookies.
    </p>
    <h2>Privacy Policy Changes</h2>
    <p>
      Although most changes are likely to be minor, Isophex may change its
      Privacy Policy from time to time, and in Isophex's sole discretion.
      Isophex encourages visitors to frequently check this page for any changes
    ...
    <p>
      ...
      <a href="mailto:jake.schroeder@isophex.com">email</a> or{" "}
      <a href="tel:6308802317">phone</a>.
    </p>
  </div>
);
